...
const ALL_ROLES = ["employee", "intern", "team_lead", "admin", "super_admin"];
const ADMIN_GROUP = ["admin", "super_admin"];
const ATTENDANCE_GROUP = ["employee", "intern", "team_lead", "admin"];
    ...
    <AutoLogout>
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={ADMIN_GROUP} />}>
          ...
          <Route path="/control-panel" element={<Navigate to="/dashboard" replace />} />
