...
export default function ApplyLeave() {
  ...
  // FIX 1: Skip both Saturday (6) and Sunday (0) — not just Sunday
  ...
  // FIX 2: Wrapped in useCallback so it can be safely listed in useEffect deps
  ...
  // FIX 3: fetchMyLeaves now safely included in deps array
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    // FIX 4: Manually validate ML certificate requirement
    // (dynamic `required` attr on inputs can be silently bypassed)
    if (
      form.leave_type === "ML" &&
          ...
          <div className="leave-grid">
            ...
            <div className="leave-card">
              ...
              <form className="leave-form" onSubmit={handleSubmit}>
                ...
                {/* ML Certificate — shown only for Medical Leave */}
                {form.leave_type === "ML" && (
                  <div className="leave-form-group">
